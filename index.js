...
//const john = new Lambdasian({ name: "John", age: 25, location: "New York" });
//console.log(john.speak()); // prints "Hello my name is John, I am from New York"
...
// class Student extends Lambdasian {
//   constructor({name, age, location, specialty, favLanguage, catchPhrase}) {
//     super({name, age, location, previousBackground, specialty, favLanguage, catchPhrase});
//     this.specialty = specialty;
//     this.favLanguage = favLanguage;
//     this.catchPhrase = catchPhrase;
//   }
